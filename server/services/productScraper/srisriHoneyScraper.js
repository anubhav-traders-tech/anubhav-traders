...
export default class SriSriHoneyScraper extends BaseScraper {
    constructor() {
        super('Sri Sri Tattva', 'https://www.srisritattva.com/collections/honey');
    }
    ...
    async processCatalog(url) {
        ...
        console.log(`[Sri Sri Honey] Found ${links.length} products.`);
